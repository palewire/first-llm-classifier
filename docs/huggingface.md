...
[![Hugging Face homepage with the tagline "The AI community building the future"](_static/huggingface.png)](https://huggingface.co/)

When you're logged in, click the icon in the upper right and select "Access Tokens" from the dropdown menu.

![Hugging Face dashboard with the user profile icon highlighted in the top right corner](_static/huggingface-panel.png)

Click on "Create new token" on the next page.

![Hugging Face Access Tokens settings page with the "Create new token" button highlighted](_static/huggingface-keys.png)
...
![Hugging Face token creation form with the token name and Inference permission highlighted](_static/huggingface-name.png)
...
![Hugging Face dialog displaying a new access token with the Copy button highlighted](_static/huggingface-copy.png)
